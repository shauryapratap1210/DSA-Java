...
public class StringCompression {
    public static int compress(char[] chars) {
        ...
        while (read < chars.length) {
            ...
            // ab count kro kitna frequency particular character ki
            while (read < chars.length && currentchar == chars[read]) {
                count++;
                read++;
            }

            // Ab count and frequency available hai
            chars[write] = currentchar;
            write++;

            // Ab count ko daalo jo 1 se jyaada hai
            if (count > 1) {
        ...
        // Ab length of compressed string
